...
void RTC_Cfg(void)
{
    ...
    RtcInitStruct.rtcTime.u8Second     = Dec2BCD(RTC_SECOND);
    RtcInitStruct.rtcTime.u8Minute     = Dec2BCD(RTC_MINUTE);
    RtcInitStruct.rtcTime.u8Hour       = Dec2BCD(RTC_HOUR);
    RtcInitStruct.rtcTime.u8Day        = Dec2BCD(RTC_DAY);
    RtcInitStruct.rtcTime.u8DayOfWeek  = Dec2BCD(RTC_DAYOFWEEK); // Friday
    RtcInitStruct.rtcTime.u8Month      = Dec2BCD(RTC_MONTH);
    RtcInitStruct.rtcTime.u8Year       = Dec2BCD(RTC_YEAR);
